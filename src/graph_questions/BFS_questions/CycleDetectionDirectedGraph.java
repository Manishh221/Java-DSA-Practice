...
public class CycleDetectionDirectedGraph {
    public static void main(String[] args) {
        ...
        BFS(adjacencyList,inDigree,ans,isVisited,  n);
    ...
    private static void BFS(List<List<Integer>> adjacencyList,int[] indegree, List<Integer> ans, boolean [] isVisited, int n) {
